                              ...
                              <tr>
                                <td align="left">
                                  <table border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                      <tr>
                                        <td> <a href="http://htmlemail.io" target="_blank">Subscribe</a> </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="content-block powered-by">
                      Powered by <a href="https://fb.me/jalasem">sakib ahemd</a>.
                    </td>
                  </tr>
                </table>
              </div>
...
exports.sendMail = (req, res, next) => {
  let mail = emailTemplate(req.body.name);
  let mailoption = {
    from: `Support From Ninja < ${process.env.GMAIL}>`,
    to: req.body.email,
